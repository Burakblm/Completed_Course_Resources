...
# kamerayada okunan görüntülere anlık erişen bilgisayarınız varsa başlangıçta,
# görüntüyü kameradan okuyabilirsiniz
...
#ret, frame = cap.read()
# if ret == False:
#     print("Gorununtu okunurken bir hata oluştu")
...
track_window = (face_x, face_y, w, h) # mean shift algoritması girdisi

# region of interest
roi = frame[face_y : face_y+h, face_x : face_x+w] # roi face

hsv_roi = cv2.cvtColor(roi,cv2.COLOR_BGR2HSV) # hsv formatına dönüştürdük
