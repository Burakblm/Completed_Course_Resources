...
4. cv : kaç katmanlı
'''
basarı = cross_val_score(estimator=classifier,X=X_train,y=y_train,cv=4)
print(basarı.mean()) # başarıların ortalamasını verir
print(basarı.std()) # başarılar arasındaki standart sapma
...
scoring : neye göre skorlanacağı : örn: accuracy
